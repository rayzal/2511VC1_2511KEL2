...
public final class AppMobil extends javax.swing.JFrame {
...
public void setJam(){
    ...
    private void TampilKarcis(){
        try{
            String sql = "SELECT * FROM karcis_mobil order by id_karcis desc";
    ...
    public void combo_jenis(){
        String Mobil = "Mobil";
        try{
        String sql = "SELECT jenis_kendaraan from tipe_kendaraan where jenis_kendaraan like '%"+Mobil+"%'";
        stt = con.createStatement();
        rss = stt.executeQuery(sql);
        while(rss.next()){
    ...
    public void combo_blok(){
        String blok_B = "B";
        try{
        String sql = "SELECT id_blok from blok where id_blok like '%"+blok_B+"%'";
        stt = con.createStatement();
        rss = stt.executeQuery(sql);
        while(rss.next()){
            Object[] ob = new Object[2];
    ...
    public void no_karcis(){
        try{
        String sql = "SELECT max(id_karcis) as maxid from karcis_mobil";
        stt = con.createStatement();
        rss = stt.executeQuery(sql);
        rss.next();
    ...
    public void Cetak_Parkir(){
            ...
            try{
                String sql = "SELECT ceiling((jam_keluar_mbl-jam_masuk_mbl)/9000) as lama from karcis_mobil where id_karcis='"+id_karcis+"'";
                stt = con.createStatement();
                rss = stt.executeQuery(sql);
                rss.next();
    ...
    public void TambahData(String id_karcis,String nopol, String jenis_mobil,String tanggal_in,String blok,
            String jam_in){
        try{
            String sql = "INSERT INTO karcis_mobil VALUES ('"+id_karcis+"','"+nopol+"','"+jenis_mobil+"',"
                    + "'"+tanggal_in+"','"+blok+"','"+jam_in+"',NULL,NULL)";
            stt = con.createStatement();
            stt.executeUpdate(sql);
            model.addRow(new Object[]{id_karcis,nopol,jenis_mobil,tanggal_in,blok,jam_in});
        }catch(SQLException e){
            System.out.println(e.getMessage());
        }
    }
    ...
    public boolean KeluarParkir(String jam_out){
        ...
        String blok = "OUT";
        try{
            String sql = "UPDATE karcis_mobil SET blok_parkir='"+blok+"',jam_keluar_mbl='"+jam_out+"' WHERE id_karcis="+id_karcis+";";
            stt = con.createStatement();
            stt.executeUpdate(sql);
            return true;
        }catch(SQLException e){
    ...
    public boolean Bayar(){
        ...
        try{
            String sql = "UPDATE karcis_mobil SET tarif='"+bayar+"' WHERE id_karcis="+id_karcis+";";
            stt = con.createStatement();
            stt.executeUpdate(sql);
            return true;
        }catch(SQLException e){
    ...
    public boolean jumlah_b1(){
        try{
            String sql = "SELECT count(blok_parkir) as jumlah from karcis_mobil WHERE blok_parkir='B1'";
           
            stt = con.createStatement();
            rss = stt.executeQuery(sql);
            rss.next();
            int jumlahh = rss.getInt("jumlah");
            String jumlah_b1= Integer.toString(jumlahh);
            jumlah1.setText(jumlah_b1);
            int batas = 100;
            int sisa = batas-jumlahh;
            String sisa_b1= Integer.toString(sisa);
            LBsisa_b1.setText(sisa_b1);
            
            String sql2 = "SELECT count(blok_parkir) as jumlah2 from karcis_mobil WHERE blok_parkir='B2'";
            stt = con.createStatement();
            rss = stt.executeQuery(sql2);
            rss.next();
            int jumlahhh = rss.getInt("jumlah2");
            String jumlah_b2= Integer.toString(jumlahhh);
            jumlah2.setText(jumlah_b2);
            int batass = 100;
            int sisaa = batass-jumlahhh;
            String sisa_b2= Integer.toString(sisaa);
            LBsisa_b2.setText(sisa_b2);
            return true;
        }catch(SQLException e){
            System.out.println(e.getMessage());
            return false;
     ...
     public void bersih(){
        txtNopol.setText("");
        CMBjenis.setSelectedItem("-- Pilih Jenis Mobil --");
    ...
    private void initComponents() {
        ...
        LBsisa_b2 = new javax.swing.JLabel();
        jLabel11 = new javax.swing.JLabel();
        LBsisa_b1 = new javax.swing.JLabel();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "No Polisi", "Jenis Mobil", "TGL Masuk", "Blok Parkir", "Jam Masuk", "Jam Keluar", "Tarif"
            }
        ) {
        ...
        CMBjenis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih Jenis Mobil --" }));
        ...
        jLabel9.setText("Sisa Blok B1");

        LBsisa_b2.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        LBsisa_b2.setForeground(new java.awt.Color(0, 92, 226));
        LBsisa_b2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LBsisa_b2.setText("100");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 92, 226));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("Sisa Blok B2");

        LBsisa_b1.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        LBsisa_b1.setForeground(new java.awt.Color(0, 92, 226));
        LBsisa_b1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LBsisa_b1.setText("100");
        ...
        jumlah2.setText("jumlah b2");

        jumlah1.setText("jumlah b1");
        ...
        panel1Layout.setHorizontalGroup(
                        ...
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panel1Layout.createSequentialGroup()
                                ...
                                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(LBsisa_b2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGap(68, 68, 68)
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel1Layout.createSequentialGroup()
                                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panel1Layout.createSequentialGroup()
                    .addGap(554, 554, 554)
                    .addComponent(LBsisa_b1, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panel1Layout.setVerticalGroup(
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(LBsisa_b2, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
            ...
            .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panel1Layout.createSequentialGroup()
                    .addGap(140, 140, 140)
                    .addComponent(LBsisa_b1, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void BTNsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNsimpanActionPerformed
        ...
        if(pilih==JOptionPane.YES_OPTION){
            ...
            String jenis_mobil = CMBjenis.getSelectedItem().toString();
              if (jenis_mobil.equals("-- Pilih Jenis Mobil --")) {
                     JOptionPane.showMessageDialog(null, "Pilih Jenis Mobil Dahulu ! ","Maaf",JOptionPane.INFORMATION_MESSAGE);
              }
            String tanggal_in = txtTglIn.getText();
            String blok = CMBblok.getSelectedItem().toString();
            if (blok.equals("-- Pilih Jenis Mobil --")) {
            ...
            TambahData(id_karcis,nopol,jenis_mobil,tanggal_in,blok,jam_in);
            bersih();
        }
        InitTable();
        TampilKarcis();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        String nopol_mobil = txtNopol2.getText();
        try
        {
            String sql = "SELECT * FROM karcis_mobil WHERE nopol_mobil like '"+nopol_mobil+"' AND tarif is NULL";
    ...
    private void txtNoKarcis2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNoKarcis2KeyPressed
        ...
        try
        {
        String sql = "SELECT * FROM karcis_mobil WHERE id_karcis like '"+no_karcis+"' AND tarif is NULL";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppMobil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel LBsisa_b1;
    private javax.swing.JLabel LBsisa_b2;
